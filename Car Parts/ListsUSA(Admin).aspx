<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ListsUSA(Admin).aspx.cs" Inherits="Car_Parts.ListsUSA_Admin_" %>
                    ...
                    <div class="heading-content-bg">
                        <div class="row">
                            <div class="heading-content col-md-8 col-sm-8">
                                <h2>
                                    إضافة تشليح السيارات الأمريكية</h2>
                                <span></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="heading-content col-md-8 col-sm-8">
                            <h2 style="color:rgba(255, 186, 0, 0.9)">
                                محتويات تشليح السيارات الأمريكية</h2>
                            <span></span>
                            <hr />
                        </div>
                    </div>
