<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ListsGER(Admin).aspx.cs" Inherits="Car_Parts.ListsGER_Admin_" %>
                    ...
                    <div class="heading-content-bg">
                        <div class="row">
                            <div class="heading-content col-md-8 col-sm-8">
                                <h2>
                                    إضافة تشليح السيارات الألمانية</h2>
                                <span></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="heading-content col-md-8 col-sm-8">
                            <h2 style="color:rgba(255, 186, 0, 0.9)">
                                محتويات تشليح السيارات الألمانية</h2>
                            <span></span>
                            <hr />
                        </div>
                    </div>
