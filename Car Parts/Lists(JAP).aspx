<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Lists(JAP).aspx.cs" Inherits="Car_Parts.Lists_JAP_" %>
                    ...
                    <div class="heading-content-bg">
                        <div class="row">
                            <div class="heading-content col-md-12 col-sm-12">
                                <h2>
                                    قسم تشليح السيارات اليابانية</h2>
                                <span></span>
                            </div>
                        </div>
                    </div>
